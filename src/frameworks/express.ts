/**
 * Express adapter for @ecoapi/node.
...
/**
 * Returns an Express middleware that initializes EcoAPI telemetry on first use.
 ...
 * ```
 */
export function createExpressMiddleware(config?: EcoAPIConfig): Middleware {
  init(config);
